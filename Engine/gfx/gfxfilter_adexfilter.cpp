...
Bitmap *AdexScanline2xGFXFilter::ShutdownAndReturnRealScreen()
{
...
Bitmap *AdexPCCRT4xGFXFilter::ShutdownAndReturnRealScreen()
{
    Bitmap *real_screen = AllegroGfxFilter::ShutdownAndReturnRealScreen();
    delete _adexScalingBuffer;
    _adexScalingBuffer = NULL;
...
Bitmap *AdexTVCRT4xGFXFilter::ShutdownAndReturnRealScreen()
{
    Bitmap *real_screen = AllegroGfxFilter::ShutdownAndReturnRealScreen();
    delete _adexScalingBuffer;
    _adexScalingBuffer = NULL;
